...
cx({option:true,"option--is-disabled":isDisabled||option.disabled,"option--is-focused":isFocused,"option--is-selected":isSelected},className),isSelected?"Select--currency__option--selected":""].join(" "),style:option.disabled?{opacity:0.5,cursor:"not-allowed"}:{}},innerProps),{},{children:[/*#__PURE__*/react["createElement"](option.image),children,/*#__PURE__*/Object(jsx_runtime["jsxs"])("span",{className:"option-balance",children:["(",option.balance.decimalPlaces(5).toString()," ",option.value,")"]})]}));};
// EXTERNAL MODULE: ./src/components/selectToken/styles.scss
var selectToken_styles = __webpack_require__(708);
...
//# sourceMappingURL=main.6ebd12a7.chunk.js.map